...
${OBJECTDIR}/src/particle-model-factory.o: src/particle-model-factory.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/particle-model-factory.o src/particle-model-factory.cpp
...
${OBJECTDIR}/src/polarizable-water.o: src/polarizable-water.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/polarizable-water.o src/polarizable-water.cpp
...
${TESTDIR}/tests/particle-model-factory-test.o: tests/particle-model-factory-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/particle-model-factory-test.o tests/particle-model-factory-test.cpp
...
${OBJECTDIR}/src/particle-model-factory_nomain.o: ${OBJECTDIR}/src/particle-model-factory.o src/particle-model-factory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/particle-model-factory_nomain.o src/particle-model-factory.cpp;\
	else  \
...
${OBJECTDIR}/src/polarizable-water_nomain.o: ${OBJECTDIR}/src/polarizable-water.o src/polarizable-water.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/polarizable-water_nomain.o src/polarizable-water.cpp;\
	else  \

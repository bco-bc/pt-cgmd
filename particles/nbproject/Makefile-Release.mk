...
${OBJECTDIR}/src/continuous-protonatable-bead.o: src/continuous-protonatable-bead.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/continuous-protonatable-bead.o src/continuous-protonatable-bead.cpp
...
${TESTDIR}/tests/particle-spec-catalog-test.o: tests/particle-spec-catalog-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/particle-spec-catalog-test.o tests/particle-spec-catalog-test.cpp


${TESTDIR}/tests/particle-test.o: tests/particle-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/particle-test.o tests/particle-test.cpp


${TESTDIR}/tests/prot-site-catalog-test.o: tests/prot-site-catalog-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/prot-site-catalog-test.o tests/prot-site-catalog-test.cpp


${TESTDIR}/tests/protonation-site-test.o: tests/protonation-site-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/protonation-site-test.o tests/protonation-site-test.cpp


${TESTDIR}/tests/read-cg-test.o: tests/read-cg-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/read-cg-test.o tests/read-cg-test.cpp
...
${OBJECTDIR}/src/atom_nomain.o: ${OBJECTDIR}/src/atom.o src/atom.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atom_nomain.o src/atom.cpp;\
	else  \
...
${OBJECTDIR}/src/atomistic_nomain.o: ${OBJECTDIR}/src/atomistic.o src/atomistic.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/atomistic_nomain.o src/atomistic.cpp;\
	else  \
...
${OBJECTDIR}/src/bead_nomain.o: ${OBJECTDIR}/src/bead.o src/bead.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bead_nomain.o src/bead.cpp;\
	else  \
...
${OBJECTDIR}/src/coarse-grained_nomain.o: ${OBJECTDIR}/src/coarse-grained.o src/coarse-grained.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/coarse-grained_nomain.o src/coarse-grained.cpp;\
	else  \
...
${OBJECTDIR}/src/continuous-protonatable-bead_nomain.o: ${OBJECTDIR}/src/continuous-protonatable-bead.o src/continuous-protonatable-bead.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/continuous-protonatable-bead_nomain.o src/continuous-protonatable-bead.cpp;\
	else  \
...
${OBJECTDIR}/src/discrete-protonatable-bead_nomain.o: ${OBJECTDIR}/src/discrete-protonatable-bead.o src/discrete-protonatable-bead.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/discrete-protonatable-bead_nomain.o src/discrete-protonatable-bead.cpp;\
	else  \
...
${OBJECTDIR}/src/particle-spec-catalog_nomain.o: ${OBJECTDIR}/src/particle-spec-catalog.o src/particle-spec-catalog.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/particle-spec-catalog_nomain.o src/particle-spec-catalog.cpp;\
	else  \
...
${OBJECTDIR}/src/particle-spec_nomain.o: ${OBJECTDIR}/src/particle-spec.o src/particle-spec.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/particle-spec_nomain.o src/particle-spec.cpp;\
	else  \
...
${OBJECTDIR}/src/particle_nomain.o: ${OBJECTDIR}/src/particle.o src/particle.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/particle_nomain.o src/particle.cpp;\
	else  \
...
${OBJECTDIR}/src/pfactory_nomain.o: ${OBJECTDIR}/src/pfactory.o src/pfactory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pfactory_nomain.o src/pfactory.cpp;\
	else  \
...
${OBJECTDIR}/src/protonation-site-catalog_nomain.o: ${OBJECTDIR}/src/protonation-site-catalog.o src/protonation-site-catalog.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -I../cpputil/include -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/protonation-site-catalog_nomain.o src/protonation-site-catalog.cpp;\
	else  \

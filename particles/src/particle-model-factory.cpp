...
namespace simploce {
    ...
    {        
        if ( !catalog_ ) {
            util::Logger logger("ParticleModelFactory::ParticleModelFactory");
            util::logAndThrow(logger,
                              "ParticleModelFactory: Missing particle specifications catalog.");
        }
    }

    Atomistic
    ParticleModelFactory::diatomic(const distance_t& distance,
                                   const spec_ptr_t& spec,
                                   const temperature_t& temperature) {
        util::Logger logger{"ParticleModelFactory::diatomic"};
    ...
    ParticleModelFactory::polarizableWater(const box_ptr_t& box,
        ...
        util::Logger logger{"ParticleModelFactory::polarizableWater"};
    ...
    Atomistic
    ParticleModelFactory::simpleElectrolyte(const box_ptr_t& box,
                                            const molarity_t& molarity,
                                            const temperature_t& temperature)
    {
        util::Logger logger{"ParticleModelFactory::simpleElectrolyte"};
    ...
    Atomistic
    ParticleModelFactory::argon(const box_ptr_t& box,
                                const density_t& densitySI,
                                const temperature_t& temperature)
    {
        util::Logger logger{"ParticleModelFactory:::argon"};
    ...
    spec_catalog_ptr_t
    ParticleModelFactory::catalog() {
        return catalog_;
    }

    void
    ParticleModelFactory::assignVelocity(atom_ptr_t& atom, const temperature_t& temperature) {
        assignVelocity_(atom, temperature);
    }

    void
    ParticleModelFactory::assignVelocity(bead_ptr_t& bead, const temperature_t& temperature) {

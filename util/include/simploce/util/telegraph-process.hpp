...
namespace simploce {
    ...
    struct TelegraphProcess {
       ...
       */
      static int increment(int current, const stime_t& dt, const rate_t& lambda);
     ...
     */
    std::ostream& 
    operator << (std::ostream& stream, const std::vector<TelegraphProcess::pair_t>& values);

...
${OBJECTDIR}/src/poisson-process.o: src/poisson-process.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/poisson-process.o src/poisson-process.cpp

${OBJECTDIR}/src/telegraph-process.o: src/telegraph-process.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/telegraph-process.o src/telegraph-process.cpp

${OBJECTDIR}/src/util.o: src/util.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/util.o src/util.cpp
...
${TESTDIR}/tests/box-cube-test.o: tests/box-cube-test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/box-cube-test.o tests/box-cube-test.cpp
...
${TESTDIR}/tests/nint-test.o: tests/nint-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/nint-test.o tests/nint-test.cpp


${TESTDIR}/tests/seed-value-test.o: tests/seed-value-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/seed-value-test.o tests/seed-value-test.cpp


${TESTDIR}/tests/telegraph-process-test.o: tests/telegraph-process-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/telegraph-process-test.o tests/telegraph-process-test.cpp


${TESTDIR}/tests/value-cvector-test.o: tests/value-cvector-test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/value-cvector-test.o tests/value-cvector-test.cpp


${TESTDIR}/tests/value_type_test.o: tests/value_type_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Iinclude -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/value_type_test.o tests/value_type_test.cpp
...
${OBJECTDIR}/src/poisson-process_nomain.o: ${OBJECTDIR}/src/poisson-process.o src/poisson-process.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/poisson-process_nomain.o src/poisson-process.cpp;\
	else  \
...
${OBJECTDIR}/src/telegraph-process_nomain.o: ${OBJECTDIR}/src/telegraph-process.o src/telegraph-process.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/telegraph-process_nomain.o src/telegraph-process.cpp;\
	else  \
...
${OBJECTDIR}/src/util_nomain.o: ${OBJECTDIR}/src/util.o src/util.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Wall -Iinclude -std=c++14 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/util_nomain.o src/util.cpp;\
	else  \

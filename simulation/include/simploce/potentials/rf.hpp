...
namespace simploce {
    ...
    public:
         ...
         */
        RF(dist_t cutoff, real_t kappa, ff_ptr_t forceField, box_ptr_t box, bc_ptr_t bc);
    ...
    private:
        ...
        real_t compute_C_rf_(const dist_t& rc, real_t eps_inside_rc, real_t eps_outside_rc) const;
